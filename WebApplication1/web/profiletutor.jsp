            ...
            <div class="container-profile">
                ...
                <div class="profile-info">
                    <img style="border-radius: 0%; width: 225px; height: 260px;
                         object-fit: cover;
                         border: 4px solid #007DA3;" 
                         src="${not empty requestScope.tutor.imageUrl ? requestScope.tutor.imageUrl : 'https://via.placeholder.com/150'}" 
                         alt="Gia Sư">

                    <div class="details">
                        <c:choose>
                            <c:when test="${not empty requestScope.tutor}">
                            ...
                            <c:when test="${not empty requestScope.user}">
                                ...
                                <p><strong>Giới tính:</strong> ${requestScope.user.gender}</p>
                                <p><strong>Địa chỉ:</strong> ${requestScope.user.address}</p>
                                <p><strong>Email:</strong> ${requestScope.user.fullName}</p>
                                <p><strong>Số điện thoại:</strong> ${requestScope.user.phoneNumber}</p>
                            </c:when>

                            <c:otherwise>
                                <p class="text-danger">Không có thông tin để hiển thị.</p>
                            </c:otherwise>
                        </c:choose>
